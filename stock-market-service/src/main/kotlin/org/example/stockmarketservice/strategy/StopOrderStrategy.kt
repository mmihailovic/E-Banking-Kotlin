...
import org.example.stockmarketservice.model.order.StopOrder
...
class StopOrderStrategy(
    ...
    public override fun isOrderExecutable(order: Order): Boolean {
        ...
        val stopOrder: StopOrder = order as StopOrder

        return (stopOrder.orderAction === OrderAction.BUY && stock.high > stopOrder.stop) ||
                (stopOrder.orderAction === OrderAction.SELL && stock.low < stopOrder.stop)
    }
}